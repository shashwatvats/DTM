...
$fk_hod_task_id = vi($_POST["assign_hod_task_id"]);
$fk_record_table_id = vi($_POST["assign_record_table_id"]);
...
$email_subject = "New Task from ".$faculty_name."";
$email_body = "
...
while($row = mysqli_fetch_assoc($result)){
	...
	$query1 = "SELECT * FROM faculty_".$faculty_department."_".$selected." WHERE fk_hod_task_id = '".$fk_hod_task_id."' AND fk_record_table_id = '".$fk_record_table_id."' AND faculty_task_assign_by != '9997188960_hod_".$faculty_department."'";
